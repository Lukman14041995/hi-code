...
@section('content')
    ...
    <section class="content">
        ...
        @endif
        {!! Form::open([
            'action' => '\Modules\Repair\Http\Controllers\JobSheetController@store',
            'id' => 'job_sheet_form',
            'method' => 'post',
            'files' => true,
        ]) !!}
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    ...
                    @php
$default_location = null; // Initialize to null by default
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="hidden" id="default_customer_mobile"
                                    value="{{ $walk_in_customer['mobile'] ?? '' }}">
                ...
                <div class="row pick_up_onsite_addr" style="display: none;">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('pick_up_on_site_addr', null, [
                                'class' => 'form-control ',
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-default bg-white btn-flat btn-modal"
                                        data-href="{{ action([\App\Http\Controllers\TaxonomyController::class, 'create']) }}?type=device"
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                {!! Form::select('device_model_id', $device_models, null, [
                                    'class' => 'form-control select2',
                                    'placeholder' => __('messages.please_select'),
                                ]) !!}
                                ...
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-default bg-white btn-flat"
                                        data-href="{{ action([\Modules\Repair\Http\Controllers\DeviceModelController::class, 'create']) }}"
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('estimated_cost', null, [
                                'class' => 'form-control input_number',
                                'placeholder' => __('repair::lang.estimated_cost'),
                            ]) !!}
                        </div>
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {{-- <div class="checkbox-inline">
                                <label class="cursor-pointer">
                                    <input type="checkbox" name="send_notification[]" value="whatsapp">
                                    Whatsapp
                                </label>
                            </div> --}}
                        </div>

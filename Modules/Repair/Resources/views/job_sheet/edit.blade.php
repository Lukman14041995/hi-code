...
@section('content')
    ...
    <section class="content">
        @if (!empty($repair_settings))
            @php
                $product_conf = isset($repair_settings['product_configuration'])
                    ? explode(',', $repair_settings['product_configuration'])
                    : [];

                $defects = isset($repair_settings['problem_reported_by_customer'])
                    ? explode(',', $repair_settings['problem_reported_by_customer'])
                    : [];

                $product_cond = isset($repair_settings['product_condition'])
                    ? explode(',', $repair_settings['product_condition'])
                    : [];
            @endphp
        @else
            @php
        ...
        @endif
        {!! Form::open([
            'url' => action([\Modules\Repair\Http\Controllers\JobSheetController::class, 'update'], [$job_sheet->id]),
            'method' => 'put',
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="hidden" id="default_customer_balance"
                                    value="{{ $job_sheet->customer->balance }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="radio-inline">
                            {!! Form::radio('service_type', 'carry_in', $job_sheet->service_type == 'carry_in' ? true : false, [
                                'class' => 'input-icheck',
                                'required',
                            ]) !!}
                        ...
                        <label class="radio-inline">
                            {!! Form::radio('service_type', 'pick_up', $job_sheet->service_type == 'pick_up' ? true : false, [
                                'class' => 'input-icheck',
                            ]) !!}
                            @lang('repair::lang.pick_up')
                        </label>
                        <label class="radio-inline radio_btns">
                            {!! Form::radio('service_type', 'on_site', $job_sheet->service_type == 'on_site' ? true : false, [
                                'class' => 'input-icheck',
                            ]) !!}
                ...
                <div class="row pick_up_onsite_addr" @if (!$avail_addr) style="display: none;" @endif>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('pick_up_on_site_addr', $job_sheet->pick_up_on_site_addr, [
                                'class' => 'form-control ',
                                'id' => 'pick_up_on_site_addr',
                                'placeholder' => __('repair::lang.pick_up_on_site_addr'),
                                'rows' => 3,
                            ]) !!}
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::select('brand_id', $brands, $job_sheet->brand_id, [
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::select('device_id', $devices, $job_sheet->device_id, [
                                'class' => 'form-control select2',
                                'placeholder' => __('messages.please_select'),
                            ]) !!}
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::select('device_model_id', $device_models, $job_sheet->device_model_id, [
                                'class' => 'form-control select2',
                                'placeholder' => __('messages.please_select'),
                            ]) !!}
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('serial_no', $job_sheet->serial_no, [
                                'class' => 'form-control',
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                {!! Form::text('security_pwd', $job_sheet->security_pwd, [
                                    'class' => 'form-control',
                                    'placeholder' => __('lang_v1.password'),
                                ]) !!}
                                <span class="input-group-btn">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('product_configuration', $job_sheet->product_configuration, [
                                'class' => 'tags-look',
                                'rows' => 4,
                            ]) !!}
                ...
                <div class="row">
                    @if (in_array('service_staff', $enabled_modules))
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('service_staff', $technecians, $job_sheet->service_staff, [
                                    'class' => 'form-control select2',
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::text(
                                'estimated_cost',
                                !empty($job_sheet->estimated_cost) ? @num_format($job_sheet->estimated_cost) : null,
                                ['class' => 'form-control input_number', 'placeholder' => __('repair::lang.estimated_cost')],
                            ) !!}
                        </div>
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text(
                                    'delivery_date',
                                    !empty($job_sheet->delivery_date) ? @format_datetime($job_sheet->delivery_date) : null,
